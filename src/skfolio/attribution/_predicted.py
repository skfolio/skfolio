...
def predicted_factor_attribution(
    ...
    **NaN handling**:
    ...
    factor_covariance : array-like of shape (n_factors, n_factors)
        ...
        using daily data). Use `annualization_factor` to scale to annualized values.
    ...
    ...     ]
    ... )
    >>> # Synthetic daily covariances; idiosyncratic residuals are uncorrelated.
    ...
    ...     ]
    ... )
    >>> idio_variances = np.array([0.00004, 0.00006, 0.00008])

    Compute annualized volatility and return contributions:

    >>> attribution = predicted_factor_attribution(
    ...     weights=weights,
    ...     loading_matrix=loading_matrix,
    ...     factor_covariance=factor_covariance,
    ...     idio_covariance=idio_variances,
    ...     asset_names=asset_names,
    ...     factor_names=factor_names,
    ...     factor_families=["Style", "Style", "Size"],
    ...     factor_mu=np.array([0.0002, 0.00012, 0.00008]),  # Daily expected returns
    ... )
    ...
    >>> attribution.families_df()
           Exposure  ... Expected Return Contribution
    Family           ...
    Style    1.2900  ...                        5.37%
    Size     0.4100  ...                        0.83%
    <BLANKLINE>
    ...
    # Apply annualization
    factor_cov = factor_cov * annualization_factor
    idio_cov = idio_cov * annualization_factor
    factor_mu = factor_mu * annualization_factor
    idio_mu = idio_mu * annualization_factor
