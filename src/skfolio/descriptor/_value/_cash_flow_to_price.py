...
class CashFlowToPrice(BaseDescriptor, stateless=True):
    ...
    .. math::
        ...
        \text{cash_flow_to_price}(t) =
        \frac{\text{operating_cash_flow_ttm}(t)}{\text{market_cap}(t)}
    ...
    .. math::
        ...
        \frac{\text{operating_cash_flow_ttm}}{\text{market_cap}}
        = \frac{\text{cash_flow_per_share}}{\text{price}}
