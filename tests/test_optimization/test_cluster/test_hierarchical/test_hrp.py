...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            dict(variance_views=["PG == 0.0005"]),
            [0.02992, 0.01775, 0.0269 , 0.04208, 0.05807, 0.05386, 0.05962,
                           0.08176, 0.03087, 0.0359 , 0.06373, 0.08529, 0.05585, 0.03192,
                           0.03929, 0.06744, 0.03824, 0.03242, 0.07893, 0.07014],
        ),
        (
            RiskMeasure.SEMI_VARIANCE,
            dict(variance_views=["PG == 0.0005"]),
            [0.02918, 0.01027, 0.02065, 0.02768, 0.04791, 0.04389, 0.05557,
                           0.10503, 0.02721, 0.0383 , 0.06376, 0.11418, 0.04856, 0.03028,
                           0.04887, 0.06736, 0.02149, 0.03327, 0.09425, 0.07229],
        ),
        (
