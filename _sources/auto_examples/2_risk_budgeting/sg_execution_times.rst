...
Computation times
=================
**00:04.378** total execution time for 3 files **from auto_examples/2_risk_budgeting**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_auto_examples_2_risk_budgeting_plot_2_risk_budgeting_CVaR.py` (``plot_2_risk_budgeting_CVaR.py``)
     - 00:01.820
     - 0.0
